...
# Project:  Treegui.pro
# Template: app
# Command: /usr/lib/qt5/bin/qmake -o Makefile Treegui.pro
#############################################################################
...
COMPRESS      = gzip -9f
DISTNAME      = main1.0.0
DISTDIR = /home/maor/Desktop/CS/SP_2/EX4_CPP/.tmp/main1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
...
Makefile: Treegui.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/sanitize.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents Demo.cpp $(DISTDIR)/


clean: compiler_clean 
	-$(DEL_FILE) $(OBJECTS)
	-$(DEL_FILE) main test Demo.o Node.o Tree.o Frontend.o Complex.o Test.o
	-$(DEL_FILE) *~ core *.core
...
testMake: Test.o Node.o Tree.o Complex.o
	g++ -o test Test.o Node.o Tree.o Complex.o
